...
typography:
  ...
  card-title:{ fontFamily: "Inter", cqw: 2.3, weight: 400, lineHeight: 1.25, tracking: "-0.005em" }
  button:  { fontFamily: "Inter", cqw: 1.46, weight: 400, lineHeight: 1.0 }
  tag-upper:{ fontFamily: "Inter", cqw: 1.35, weight: 400, tracking: "0.18em", upper: true }
...
- **Fonts** — already set to **Inter** (display) / **JetBrains Mono** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{300, 400, 700, 800, 900}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
